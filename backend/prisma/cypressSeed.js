...
import seedDevices from './cypressDevices.json' with { type: 'json' };
import seedSensorData from './cypressSensorData.json' with { type: 'json' };
import seedBlocks from './cypressBlocks.json' with { type: 'json' };
