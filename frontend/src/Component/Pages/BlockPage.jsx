        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-8 px-2 sm:px-4">
            {devices.map((device) => (
              ...
              >
                <div
                  className={`bg-white rounded-2xl px-4 py-4 sm:px-6 sm:py-6 shadow-sm border border-gray-200 transition-all duration-300 ${getCo2HoverBgColor(checkOfflineDate(device.createdAt) ? 0 : device.co2)}`}
                >
                  <div className="flex flex-col justify-between h-full">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                      <div className="text-left mr-2 flex-1">
                        <div className="text-3xl sm:text-4xl md:text-5xl text-gray-800 mb-2">
                        ...
                        <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-2">
                          ...
                          <span className="text-base sm:text-xl md:text-2xl text-gray-500 font-normal ml-1">ppm</span>
                        </div>
                      </div>
