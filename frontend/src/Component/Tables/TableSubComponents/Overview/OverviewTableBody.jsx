      ...
      {tableFields.map((item) => { // Iterate through the tableFields array and render each room with sensor data
        ...
        return (
          <tr key={item.dev_eui} className="hover:bg-gray-100 even:bg-gray-50">
            <td className="pl-4 py-2 font-bold text-black text-lg whitespace-nowrap">
              {item.room_number}
            </td>
            ...
            <td className={`pl-1 pr-4 py-2 font-medium text-gray-900 whitespace-nowrap ${getLastUpdatedClass(minutesSinceLastUpdated)}`}>
