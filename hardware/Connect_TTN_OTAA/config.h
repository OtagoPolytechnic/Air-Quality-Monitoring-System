...
SX1276 radio = new Module(18, 26, 23, 33); // LoRa32 T V2.1.6.1 Pin out 
...
#define RADIOLIB_LORAWAN_DEV_EUI   0x---------------- // Do NOT replace the 0x, paste your key over the '-' symbol only.
#endif
